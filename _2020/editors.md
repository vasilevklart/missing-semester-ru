...
behavior. **Download our config [here]({{ site.baseurl }}/2020/files/vimrc) and save it to
`~/.vimrc`.**
...
- Example: convert xml to json ([file]({{ site.baseurl }}/2020/files/example-data.xml))
...
1. Complete `vimtutor`. Note: it looks best in a
   ...
   terminal window.
1. Download our [basic vimrc]({{ site.baseurl }}/2020/files/vimrc) and save it to `~/.vimrc`. Read
...
1. (Advanced) Convert XML to JSON ([example file]({{ site.baseurl }}/2020/files/example-data.xml))

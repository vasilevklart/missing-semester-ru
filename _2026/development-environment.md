...
- [Лекция о Vim]({{ site.baseurl }}/2020/editors/) из предыдущего выпуска этого курса – там мы разобрали Vim подробнее
...
Агенты для программирования подробно разбираются в [лекции об агентном программировании]({{ site.baseurl }}/2026/agentic-coding/).

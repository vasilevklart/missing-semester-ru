...
Эта лекция опирается на материал о разработке с помощью ИИ из лекции [Среда разработки и инструменты]({{ site.baseurl }}/2026/development-environment/). В качестве быстрой демонстрации продолжим пример из раздела [Разработка с помощью ИИ]({{ site.baseurl }}/2026/development-environment/#ai-powered-development):
...
{% endcomment %}
- **Рефакторинг.** С помощью агентов для программирования можно рефакторить код самыми разными способами: от простых задач вроде переименования метода (такой рефакторинг умеют делать и средства [интеллектуальной работы с кодом]({{ site.baseurl }}/2026/development-environment/#code-intelligence-and-language-servers)) до более сложных – например, выделения функциональности в отдельный модуль.
